...
//        clubsDataAccessObject.addClub(tempClubFactory.create("UTRG", "The University of Toronto Rhythm Gaming Club (UTRG) is the official student organization for rhythm game enthusiasts across the U of T campuses. This vibrant community unites students who share a passion for games involving timing and musicality, from popular titles like Dance Dance Revolution (DDR) and StepMania to mobile and PC favorites. UTRG provides a welcoming space for both seasoned players and newcomers. The club hosts regular casual meetups, competitive tournaments, and social events like arcade outings. Members connect and practice skills on various platforms and controllers, fostering a supportive environment to improve their gameplay. Operating primarily out of the St. George campus, UTRG actively uses its online platforms, particularly its Discord server and website (utrg.ca), to coordinate events and build community. There are no fees to join standard meetings, making it an accessible and engaging way for students to de-stress and make friends through music and games."));
